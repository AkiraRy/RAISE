...
VOICE_FILE_OUT = os.getenv('VOICE_FILE_OUT')
...
def rvc_infer_colab():
    params_encoded = urlencode(
        {'model': MODEL_NAME, 'pitch': PITCH_CHANGE, 'algo': PITCH_EXTRACTION_ALGO, 'volume': VOLUME_ENVELOPE,
...
if __name__ == '__main__':
    INPUT_VOICE_PATH = str(AUDIO_DIR/VOICE_FILE)
    OUTPUT_VOICE_PATH = str(AUDIO_DIR/VOICE_FILE_OUT)
    rvc_infer_colab()
    # CHUNK = 1024
