...
from .handlers import handle_message, handle_message_server, error_handler, help_command, start_command, whitelist_user
...
class TelegramInterface(BaseInterface):
    ...
    def initialize(self):
        ...
        self.app.add_handlers([
            ...
            MessageHandler(filters.TEXT, handle_message_server),
        ])
